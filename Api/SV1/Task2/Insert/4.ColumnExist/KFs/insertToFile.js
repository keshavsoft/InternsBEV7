...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {StudentName : LocalCoumnStudentName,Mobile : LocalCoumnMobile,Email : LocalCoumnEmail,CollegeName : LocalCoumnCollegeName,YearPassOut : LocalCoumnYearPassOut,RollNumber : LocalCoumnRollNumber,GitLink : LocalCoumnGitLink,HostLink : LocalCoumnHostLink};
